...
using System.Linq;
using SaoTseaDsApi.EntitiesCode;
namespace SaoTseaDsApi.EntitiesCode
{
...
{
    public static class saoSystemTextJsonExtensions
    {
        public static IServiceCollection AddsaoJsonOptions(this IServiceCollection builder)
        {
