...
namespace SaoTsea.Ds.Api.EntitiesCode
{
    ...
    [Persistent(@"view_count_status_proc_inst")]
    public partial class VIEW_COUNT_STATUS_PROC_INST : XPLiteObject
    {
        long fROW_NUMBER;
        [Key]
        ...
        long fCOUNTSTATUS_CODE;
        [Persistent(@"countstatus_code")]
        public long COUNTSTATUS_CODE
        {
            get { return fCOUNTSTATUS_CODE; }
            set { SetPropertyValue<long>(nameof(COUNTSTATUS_CODE), ref fCOUNTSTATUS_CODE, value); }
        }
    }
