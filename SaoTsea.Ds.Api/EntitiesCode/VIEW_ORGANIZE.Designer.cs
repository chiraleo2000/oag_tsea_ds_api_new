...
namespace SaoTsea.Ds.Api.EntitiesCode
{
    ...
    [Persistent(@"view_organize")]
    public partial class VIEW_ORGANIZE : XPLiteObject
    {
        int fORGANIZE_ID;
        [Key]
        ...
        int fORGANIZE_LEVEL_PARENT;
        [Persistent(@"organize_level_parent")]
        public int ORGANIZE_LEVEL_PARENT
        {
            get { return fORGANIZE_LEVEL_PARENT; }
            set { SetPropertyValue<int>(nameof(ORGANIZE_LEVEL_PARENT), ref fORGANIZE_LEVEL_PARENT, value); }
        }
        string fMANAGER_FULL_NAME;
        [Size(SizeAttribute.Unlimited)]
        [Persistent(@"manager_full_name")]
        public string MANAGER_FULL_NAME
        {
            get { return fMANAGER_FULL_NAME; }
            set { SetPropertyValue<string>(nameof(MANAGER_FULL_NAME), ref fMANAGER_FULL_NAME, value); }
        }
        string fMANAGER2_FULL_NAME;
        [Size(SizeAttribute.Unlimited)]
        [Persistent(@"manager2_full_name")]
        public string MANAGER2_FULL_NAME
        {
            get { return fMANAGER2_FULL_NAME; }
            set { SetPropertyValue<string>(nameof(MANAGER2_FULL_NAME), ref fMANAGER2_FULL_NAME, value); }
        }
        string fMANAGER_POSITION;
        [Size(500)]
        [Persistent(@"manager_position")]
        public string MANAGER_POSITION
        {
            get { return fMANAGER_POSITION; }
            set { SetPropertyValue<string>(nameof(MANAGER_POSITION), ref fMANAGER_POSITION, value); }
        }
        string fROOT_ORGANIZE_NAME_THA;
        [Size(500)]
        [Persistent(@"root_organize_name_tha")]
        public string ROOT_ORGANIZE_NAME_THA
        {
            get { return fROOT_ORGANIZE_NAME_THA; }
            set { SetPropertyValue<string>(nameof(ROOT_ORGANIZE_NAME_THA), ref fROOT_ORGANIZE_NAME_THA, value); }
        }
    }
