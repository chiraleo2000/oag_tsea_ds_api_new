...
namespace SaoTsea.Ds.Api.EntitiesCode
{
    ...
    [Persistent(@"view_proc_inst_log")]
    public partial class VIEW_PROC_INST_LOG : XPLiteObject
    {
        int fINST_LOG_ID;
        [Key]
        ...
        string fOFFICER_PROGRESS_FULL_NAME;
        [Size(SizeAttribute.Unlimited)]
        [Persistent(@"officer_progress_full_name")]
        public string OFFICER_PROGRESS_FULL_NAME
        {
            get { return fOFFICER_PROGRESS_FULL_NAME; }
            set { SetPropertyValue<string>(nameof(OFFICER_PROGRESS_FULL_NAME), ref fOFFICER_PROGRESS_FULL_NAME, value); }
        }
    }
