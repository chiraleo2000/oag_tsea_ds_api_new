...
namespace SaoTsea.Ds.Api.EntitiesCode
{
    ...
    [Persistent(@"view_proc_inst_v2")]
    public partial class VIEW_PROC_INST_V2 : XPLiteObject
    {
        int fINST_ID;
        [Key]
        [Persistent(@"inst_id")]
        ...
        int fOFFCER_POSITION_MNG_ID;
        [Persistent(@"offcer_position_mng_id")]
        public int OFFCER_POSITION_MNG_ID
        {
            get { return fOFFCER_POSITION_MNG_ID; }
            set { SetPropertyValue<int>(nameof(OFFCER_POSITION_MNG_ID), ref fOFFCER_POSITION_MNG_ID, value); }
        }
        string fOFFCER_WORK_LINE_CODE;
        [Size(20)]
        [Persistent(@"offcer_work_line_code")]
        public string OFFCER_WORK_LINE_CODE
        {
            get { return fOFFCER_WORK_LINE_CODE; }
            set { SetPropertyValue<string>(nameof(OFFCER_WORK_LINE_CODE), ref fOFFCER_WORK_LINE_CODE, value); }
        }
        string fFLOW_CODE;
        [Size(500)]
        ...
        string fSTATUS_NAME_OFFICER;
        [Size(200)]
        [Persistent(@"status_name_officer")]
        public string STATUS_NAME_OFFICER
        {
            get { return fSTATUS_NAME_OFFICER; }
            set { SetPropertyValue<string>(nameof(STATUS_NAME_OFFICER), ref fSTATUS_NAME_OFFICER, value); }
        }
